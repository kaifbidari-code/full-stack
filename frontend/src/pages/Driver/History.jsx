  ...
  return (
    <div className="container animate-fade-in">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <Link to="/driver/dashboard" className="btn" style={{ width: 'auto', background: 'rgba(255,255,255,0.1)' }}>← Back to Dashboard</Link>
      </div>
      ...
      <div className="glass-panel">
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '3rem' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', marginTop: '1rem' }}>You have not completed any rides yet.</p>
          </div>
        ) : (
              ...
              return (
                <li key={ride._id} style={{ 
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 2fr 1fr 1fr 1fr', gap: '1rem', alignItems: 'center' }}>
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginBottom: '0.25rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Fare Earned</p>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', marginTop: '0.5rem' }}>
                        Rider: {ride.riderId ? ride.riderId.username : 'N/A'}
                      </p>
                      {ride.rating && (
                        <div style={{ marginTop: '0.25rem' }}>
                          ...
                          {ride.review && <p style={{ fontSize: '0.78rem', color: 'var(--text-secondary)', fontStyle: 'italic', marginTop: '0.2rem' }}>"{ride.review}"</p>}
                        </div>
                      )}
                    </div>
                  </div>
